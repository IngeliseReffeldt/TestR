...
lrn_gam_t = lrn_gam = make_encoded_learner(lrn("regr.gam",
                                               formula=ClaimAmount ~ s(Exposure) + s(LicAge) + s(RecordBeg) + s(RecordEnd) + VehAge + Gender + MariStat + SocioCateg + VehUsage + s(DrivAge) + HasKmLimit + s(BonusMalus) + VehBody + VehPrice + VehEngine+VehEnergy+VehMaxSpeed + VehClass + s(RiskVar) + Garage,
