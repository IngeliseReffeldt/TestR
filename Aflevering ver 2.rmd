...
df_no_gender <- 
  data.frame(
    ...
    y = shapley_values(learner_rf_tuned_no_gender,task_no_gender,gns_kunde_no_gender,1000)
  )

ggplot(df, aes(x=y,y=x)) +
  geom_col() +
  labs(x="Shapley Value", y = "Feature", title = "Gns_kunde, no gender")

explainer_no_gender <- explainer_fun(learner_rf_tuned_no_gender, task_no_gender)
